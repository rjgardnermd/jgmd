...
def demo_deferred_evaluation():
    ...
    logger = Logger(name="deferred_demo", log_level=logging.INFO, colored_console=True)
...
def demo_icons_and_colors():
    ...
    logger = Logger(name="icons_demo", log_level=logging.INFO, colored_console=True)
...
def demo_cloud_logging_compatibility():
    ...
    logger = Logger(name="cloud_demo", log_level=logging.INFO, colored_console=True)
